...
EXPERT_FILE = os.path.join(PROJECT_DIR, '00_data', 'labels.csv')
DETAIL_FILE = os.path.join(RESULTS_DIR, 'nlp_detailed_features.csv')
...
def save_results(results, selected_features, svr_params, rf_params, n):
    ...
    path = os.path.join(RESULTS_DIR, 'calibration_svr_summary.txt')
    ...
    config_path = os.path.join(RESULTS_DIR, 'svr_rf_config.json')
    config = {
